  ...
  <header class="c-header">
    <nav class="nav">
      <div class="navbar__brand">
        ...
        <router-link to="/" class="navbar__textbrand">Secret Chat</router-link>
      </div>
      ...
      <ul class="navbar__nav navbar__nav--right" v-if="!isAuthorized">
        ...
        <li class="nav__item">
          <a
              href="https://github.com/stanislavkhatko/secret-realtime-chat"
              target="_blank"
              class="nav__link"
          >
    ...
    <nav class="snav" v-bind:class="{ 'snav--shown': navToggleState }">
      ...
      <ul class="snav__nav" v-if="isAuthorized">
        <li class="snav__item">
          <router-link to="/rooms" class="nav__link nav__link--rounded"
          >Rooms
          </router-link
          >
        </li>
...
import ToggleTheme from '@/elements/ToggleTheme.vue';
